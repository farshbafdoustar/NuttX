...
#define MR_CONFIG_MAX_OUTPUT_BEST_EFFORT_STREAMS     1
#define MR_CONFIG_MAX_OUTPUT_RELIABLE_STREAMS        1
#define MR_CONFIG_MAX_INPUT_BEST_EFFORT_STREAMS      1
#define MR_CONFIG_MAX_INPUT_RELIABLE_STREAMS         1

#define MR_CONFIG_MAX_SESSION_CONNECTION_ATTEMPTS    10
#define MR_CONFIG_MIN_SESSION_CONNECTION_INTERVAL    1
#define MR_CONFIG_MIN_HEARTBEAT_TIME_INTERVAL        1

#define MR_CONFIG_UDP_TRANSPORT_MTU                  
#define MR_CONFIG_TCP_TRANSPORT_MTU                  
#define MR_CONFIG_SERIAL_TRANSPORT_MTU               350
